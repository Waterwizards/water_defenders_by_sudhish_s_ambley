...
class MeterReadingsControllerTest < ActionController::TestCase
  ...
  test "should create meter_reading" do
    assert_difference('MeterReading.count') do
      post :create, meter_reading: { read_at: @meter_reading.read_at, unit: @meter_reading.unit, user_id: @meter_reading.user_id, value: @meter_reading.value }
    end
  ...
  test "should update meter_reading" do
    patch :update, id: @meter_reading, meter_reading: { read_at: @meter_reading.read_at, unit: @meter_reading.unit, user_id: @meter_reading.user_id, value: @meter_reading.value }
    assert_redirected_to meter_reading_path(assigns(:meter_reading))
  end
